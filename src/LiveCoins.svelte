<script>
    ...
    */
    ...
    // usdt_socket.onmessage = function (event) {
    //     var usdt_data = JSON.parse(event.data);
    //     let usdt_data_dict = {'x':usdt_data['E'], 'y':parseFloat(usdt_data['p'])}
    //     // let dataDict = {'x':data['E'], 'y':parseFloat(data['c'])}
    //     if (usdt_data_dict.x>usdt_x2) usdt_x2 = usdt_data_dict.x;
    //     if (usdt_data_dict.x<usdt_x1) usdt_x1 = usdt_data_dict.x;
    //     if (usdt_data_dict.y>usdt_y2) usdt_y2 = usdt_data_dict.y;
    //     if (usdt_data_dict.y<usdt_y1) usdt_y1 = usdt_data_dict.y;
    //     // if (usdt_x2-usdt_x1>60000) usdt_x1 = usdt_x2-60000
    //     if (usdt_x2-usdt_x1>86400000) usdt_x1 = usdt_x2-86400000
    //     usdt_alldata.push(usdt_data_dict);
    //     usdt_alldata=[...usdt_alldata.filter(data => data.x > usdt_x1)]
    //     console.log(usdt_alldata[usdt_alldata.length-1]);
    // }
...
<div class='chart-grid twoXfour'>
    ...
    <!-- <LineChart bind:data={usdt_alldata} bind:x1={usdt_x1} bind:x2={usdt_x2} bind:y1={usdt_y1} bind:y2={usdt_y2}/> -->
