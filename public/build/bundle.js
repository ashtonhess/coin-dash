...
var app = (function () {
    ...
    function instance$f($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Grid> was created with unknown prop '${key}'`);
    	});
    ...
    // (17:8) <Pancake.Grid horizontal count = {5} let:value>
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span = element("span");
    			t = text(t_value);
    			attr_dev(span, "class", "svelte-ipupoi");
    			add_location(span, file$2, 17, 46, 378);
    			attr_dev(div, "class", "grid-line horizontal svelte-ipupoi");
    			add_location(div, file$2, 17, 12, 344);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, span);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*value*/ 64 && t_value !== (t_value = /*value*/ ctx[6] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(17:8) <Pancake.Grid horizontal count = {5} let:value>",
    		ctx
    	});
    ...
    // (21:12) <Pancake.SvgLine data={data} let:d>
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path, "class", "data svelte-ipupoi");
    			attr_dev(path, "d", path_d_value = /*d*/ ctx[5]);
    			add_location(path, file$2, 21, 16, 515);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, path, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*d*/ 32 && path_d_value !== (path_d_value = /*d*/ ctx[5])) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(21:12) <Pancake.SvgLine data={data} let:d>",
    		ctx
    	});
    ...
    function create_default_slot_1(ctx) {
    	...
    	pancake_svgline = new SvgLine({
    			props: {
    				data: /*data*/ ctx[4],
    				$$slots: {
    					default: [create_default_slot_2, ({ d }) => ({ 5: d }), ({ d }) => d ? 32 : 0]
    				},
    				$$scope: { ctx }
    			},
    			$$inline: true
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*data*/ 16) pancake_svgline_changes.data = /*data*/ ctx[4];

    			if (dirty & /*$$scope, d*/ 160) {
    ...
    // (16:4) <Pancake.Chart {x1} {x2} {y1} {y2}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			create_component(pancake_grid.$$.fragment);
    			t = space();
    			create_component(pancake_svg.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(pancake_grid, target, anchor);
    			insert_dev(target, t, anchor);
    			mount_component(pancake_svg, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, dirty) {
    			const pancake_grid_changes = {};

    			if (dirty & /*$$scope, value*/ 192) {
    				pancake_grid_changes.$$scope = { dirty, ctx };
    			}

    			pancake_grid.$set(pancake_grid_changes);
    			const pancake_svg_changes = {};

    			if (dirty & /*$$scope, data*/ 144) {
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(pancake_grid.$$.fragment, local);
    			transition_in(pancake_svg.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(pancake_grid.$$.fragment, local);
    			transition_out(pancake_svg.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(pancake_grid, detaching);
    			if (detaching) detach_dev(t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(16:4) <Pancake.Chart {x1} {x2} {y1} {y2}>",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "chart svelte-ipupoi");
    			add_location(div, file$2, 14, 0, 216);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*x1*/ 1) pancake_chart_changes.x1 = /*x1*/ ctx[0];
    			if (dirty & /*x2*/ 2) pancake_chart_changes.x2 = /*x2*/ ctx[1];
    			if (dirty & /*y1*/ 4) pancake_chart_changes.y1 = /*y1*/ ctx[2];
    			if (dirty & /*y2*/ 8) pancake_chart_changes.y2 = /*y2*/ ctx[3];
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let { data = [] } = $$props;
    	const writable_props = ['x1', 'x2', 'y1', 'y2', 'data'];
    	...
    	$$self.$capture_state = () => ({ Pancake, x1, x2, y1, y2, data });
    ...
    class LineChart extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { x1: 0, x2: 1, y1: 2, y2: 3, data: 4 });
    ...
    function create_fragment$1(ctx) {
    	...
    	function linechart0_data_binding(value) {
    		/*linechart0_data_binding*/ ctx[10](value);
    	}

    	function linechart0_x1_binding(value) {
    		/*linechart0_x1_binding*/ ctx[11](value);
    	}

    	function linechart0_x2_binding(value) {
    		/*linechart0_x2_binding*/ ctx[12](value);
    	}

    	function linechart0_y1_binding(value) {
    		/*linechart0_y1_binding*/ ctx[13](value);
    	}

    	function linechart0_y2_binding(value) {
    		/*linechart0_y2_binding*/ ctx[14](value);
    	}

    	let linechart0_props = {};

    	if (/*btc_alldata*/ ctx[8] !== void 0) {
    		linechart0_props.data = /*btc_alldata*/ ctx[8];
    	}

    	if (/*btc_x1*/ ctx[0] !== void 0) {
    		linechart0_props.x1 = /*btc_x1*/ ctx[0];
    	}

    	if (/*btc_x2*/ ctx[1] !== void 0) {
    		linechart0_props.x2 = /*btc_x2*/ ctx[1];
    	}

    	if (/*btc_y1*/ ctx[2] !== void 0) {
    		linechart0_props.y1 = /*btc_y1*/ ctx[2];
    	}

    	if (/*btc_y2*/ ctx[3] !== void 0) {
    		linechart0_props.y2 = /*btc_y2*/ ctx[3];
    	}
    	...
    	function linechart1_data_binding(value) {
    		/*linechart1_data_binding*/ ctx[15](value);
    	}

    	function linechart1_x1_binding(value) {
    		/*linechart1_x1_binding*/ ctx[16](value);
    	}

    	function linechart1_x2_binding(value) {
    		/*linechart1_x2_binding*/ ctx[17](value);
    	}

    	function linechart1_y1_binding(value) {
    		/*linechart1_y1_binding*/ ctx[18](value);
    	}

    	function linechart1_y2_binding(value) {
    		/*linechart1_y2_binding*/ ctx[19](value);
    	}

    	let linechart1_props = {};

    	if (/*eth_alldata*/ ctx[9] !== void 0) {
    		linechart1_props.data = /*eth_alldata*/ ctx[9];
    	}

    	if (/*eth_x1*/ ctx[4] !== void 0) {
    		linechart1_props.x1 = /*eth_x1*/ ctx[4];
    	}

    	if (/*eth_x2*/ ctx[5] !== void 0) {
    		linechart1_props.x2 = /*eth_x2*/ ctx[5];
    	}

    	if (/*eth_y1*/ ctx[6] !== void 0) {
    		linechart1_props.y1 = /*eth_y1*/ ctx[6];
    	}

    	if (/*eth_y2*/ ctx[7] !== void 0) {
    		linechart1_props.y2 = /*eth_y2*/ ctx[7];
    	}
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(linechart0, target, anchor);
    			insert_dev(target, t2, anchor);
    			mount_component(linechart1, target, anchor);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			const linechart0_changes = {};

    			if (!updating_data && dirty & /*btc_alldata*/ 256) {
    				updating_data = true;
    				linechart0_changes.data = /*btc_alldata*/ ctx[8];
    				add_flush_callback(() => updating_data = false);
    			}

    			if (!updating_x1 && dirty & /*btc_x1*/ 1) {
    				updating_x1 = true;
    				linechart0_changes.x1 = /*btc_x1*/ ctx[0];
    				add_flush_callback(() => updating_x1 = false);
    			}

    			if (!updating_x2 && dirty & /*btc_x2*/ 2) {
    				updating_x2 = true;
    				linechart0_changes.x2 = /*btc_x2*/ ctx[1];
    				add_flush_callback(() => updating_x2 = false);
    			}

    			if (!updating_y1 && dirty & /*btc_y1*/ 4) {
    				updating_y1 = true;
    				linechart0_changes.y1 = /*btc_y1*/ ctx[2];
    				add_flush_callback(() => updating_y1 = false);
    			}

    			if (!updating_y2 && dirty & /*btc_y2*/ 8) {
    				updating_y2 = true;
    				linechart0_changes.y2 = /*btc_y2*/ ctx[3];
    			...
    			if (!updating_data_1 && dirty & /*eth_alldata*/ 512) {
    				updating_data_1 = true;
    				linechart1_changes.data = /*eth_alldata*/ ctx[9];
    				add_flush_callback(() => updating_data_1 = false);
    			}

    			if (!updating_x1_1 && dirty & /*eth_x1*/ 16) {
    				updating_x1_1 = true;
    				linechart1_changes.x1 = /*eth_x1*/ ctx[4];
    				add_flush_callback(() => updating_x1_1 = false);
    			}

    			if (!updating_x2_1 && dirty & /*eth_x2*/ 32) {
    				updating_x2_1 = true;
    				linechart1_changes.x2 = /*eth_x2*/ ctx[5];
    				add_flush_callback(() => updating_x2_1 = false);
    			}

    			if (!updating_y1_1 && dirty & /*eth_y1*/ 64) {
    				updating_y1_1 = true;
    				linechart1_changes.y1 = /*eth_y1*/ ctx[6];
    				add_flush_callback(() => updating_y1_1 = false);
    			}

    			if (!updating_y2_1 && dirty & /*eth_y2*/ 128) {
    				updating_y2_1 = true;
    				linechart1_changes.y2 = /*eth_y2*/ ctx[7];
    		...
    		d: function destroy(detaching) {
    			...
    			destroy_component(linechart0, detaching);
    			if (detaching) detach_dev(t2);
    			destroy_component(linechart1, detaching);
    		}
    	};
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	btc_socket.onmessage = function (event) {
    		...
    		if (btc_data_dict.x > btc_x2) $$invalidate(1, btc_x2 = btc_data_dict.x);

    		if (btc_data_dict.x < btc_x1) $$invalidate(0, btc_x1 = btc_data_dict.x);
    		if (btc_data_dict.y > btc_y2) $$invalidate(3, btc_y2 = btc_data_dict.y);
    		if (btc_data_dict.y < btc_y1) $$invalidate(2, btc_y1 = btc_data_dict.y);
    		if (btc_x2 - btc_x1 > 60000) $$invalidate(0, btc_x1 = btc_x2 - 60000);
    		btc_alldata.push(btc_data_dict);
    		$$invalidate(8, btc_alldata = [...btc_alldata.filter(data => data.x > btc_x1)]);
    	...
    	eth_socket.onmessage = function (event) {
    		...
    		// let dataDict = {'x':data['E'], 'y':parseFloat(data['c'])}
    		if (eth_data_dict.x > eth_x2) $$invalidate(5, eth_x2 = eth_data_dict.x);

    		if (eth_data_dict.x < eth_x1) $$invalidate(4, eth_x1 = eth_data_dict.x);
    		if (eth_data_dict.y > eth_y2) $$invalidate(7, eth_y2 = eth_data_dict.y);
    		if (eth_data_dict.y < eth_y1) $$invalidate(6, eth_y1 = eth_data_dict.y);
    		if (eth_x2 - eth_x1 > 60000) $$invalidate(4, eth_x1 = eth_x2 - 60000);
    		eth_alldata.push(eth_data_dict);
    		$$invalidate(9, eth_alldata = [...eth_alldata.filter(data => data.x > eth_x1)]);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<LiveCoins> was created with unknown prop '${key}'`);
    	});

    	function linechart0_data_binding(value) {
    		btc_alldata = value;
    		$$invalidate(8, btc_alldata);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ('btc_x1' in $$props) $$invalidate(0, btc_x1 = $$props.btc_x1);
    		if ('btc_x2' in $$props) $$invalidate(1, btc_x2 = $$props.btc_x2);
    		if ('btc_y1' in $$props) $$invalidate(2, btc_y1 = $$props.btc_y1);
    		if ('btc_y2' in $$props) $$invalidate(3, btc_y2 = $$props.btc_y2);
    		if ('eth_x1' in $$props) $$invalidate(4, eth_x1 = $$props.eth_x1);
    		if ('eth_x2' in $$props) $$invalidate(5, eth_x2 = $$props.eth_x2);
    		if ('eth_y1' in $$props) $$invalidate(6, eth_y1 = $$props.eth_y1);
    		if ('eth_y2' in $$props) $$invalidate(7, eth_y2 = $$props.eth_y2);
    		if ('btc_alldata' in $$props) $$invalidate(8, btc_alldata = $$props.btc_alldata);
    		if ('eth_alldata' in $$props) $$invalidate(9, eth_alldata = $$props.eth_alldata);
    ...
    function create_fragment(ctx) {
    	...
    	let livecoins;
    	let current;
    	livecoins = new LiveCoins({ $$inline: true });

    	const block = {
    		c: function create() {
    			main = element("main");
    			create_component(livecoins.$$.fragment);
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(livecoins, main, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(livecoins.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(livecoins.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(main);
    			destroy_component(livecoins);
    		}
    	};
